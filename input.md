...
3.  После создания базы данных через веб интерфейс, создаем таблицы с
    ...
    ![](./image1.png){width="4.197916666666667in"
    height="2.375in"}
...
4.  Создание индекса для поиска по датам, показанный на рисунке 2.
    ...
    ![](./image2.png){width="5.979166666666667in"
    height="2.1875in"}
...
5.  Добавляем данные для каждой таблицы, как показано на рисунке 3.
    ...
    ![](./image3.png){width="6.495138888888889in"
...
![](./image4.png){width="6.490972222222222in"
...
![](./image9.png){width="4.552083333333333in"
